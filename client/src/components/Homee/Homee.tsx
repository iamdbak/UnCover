...
const Homee: React.FC = () => {
  ...
  dispatch(updateCurrentPath("homee", ""));
    ...
    <Fragment>
      ...
      <div className="row">
        ...
        <div className="col-xl-6 col-lg-6">
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-green">Submission list</h6>
            </div>
        ...
        <div className="col-xl-6 col-lg-6">
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-green">Quiz list</h6>
            </div>
            <div className="card-body">
              <OrderList />
            </div>

...
import { changeSelectedProduct, clearSelectedProduct } from "../../store/actions/Products.actions";
...
const Orders: React.FC = () => {
    ...
    return (
        <Fragment>
            <h1 className="h3 mb-2 text-gray-800">Test</h1>
            <p className="mb-4">Test here</p>
